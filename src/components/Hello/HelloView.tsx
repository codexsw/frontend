...
export const HelloView: FC<HelloViewProps> = ({ name, onQuery }) => {
  return (
    <div
      className='flex min-h-screen cursor-pointer flex-col items-center justify-center bg-blue-50'
      onClick={onQuery}
    >
      <div className='relative flex max-w-[500px] flex-col gap-6 overflow-hidden rounded-lg border border-gray-100 bg-white p-8'>
